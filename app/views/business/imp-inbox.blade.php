        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
            ...
            <ul class="dropdown-menu menu-dashboard" role="menu">
              ...
              <li><a href="#"><span class="fa fa-comment-o"></span>Nhận xét</a></li>
			      ...
			      <div class="navbar navbar-default" role="navigation">
			        ...
			        <div class="navbar-collapse collapse sidebar-navbar-collapse">
			          <ul class="nav navbar-nav menu-inbox">
			            <li class="e-inbox"><a href="{{URL::route('write_inbox')}}" class="btn btn-primary e-inbox-text" style="margin-left:6%">Soạn thư mới</a></li>
			            <li class="a-inbox">
	              			...
	              			@if(!empty($messages))
								@foreach($messages as $message)
								  ...
								  <tr class="tr-load">
								    ...
								    <td><a href="{{URL::route('detail_imp_inbox',array($message->id))}}">{{Vendor::where('id',$message->from_business)->get()->first()->name}}</a></td>
								    <td ><a href="{{URL::route('detail_imp_inbox',array($message->id))}}">{{$message->title}}</a></td>
